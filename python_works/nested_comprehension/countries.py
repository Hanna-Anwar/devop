...
#create a fun get_country_capital(country_name)
...
def most_populated_country():
  ...
  population =  [c.get("population") for c in countries]
  ...
  return [c.get("name") for c in countries if c.get("population") == max_population]

# print(most_populated_country())
 
# display name of least_populated_country*****************************

def least_populated_country():
  ...
  return [c.get("name") for  c in countries if c.get("population") == min_population]

# print(least_populated_country())

# display indepenedent country names***********************

def independent_countries():
...
def all_region():
    ...
    return [c.get("region") for c in countries]
...
def asian_region():
    ...
    return [c.get("name") for c in countries if c.get("region").lower() == "asia".lower() ]

# print(asian_region())

#display indian borders********************'borders': ['AFG', 'BGD', 'BTN', 'MMR', 'CHN', 'NPL', 'PAK', 'LKA']

def indian_border():
    
    return [c.get("borders") for c in countries if c.get("name") == "India" ]
...
def native_name(country_name):
    
    return [c.get("nativeName") for c in countries if c.get("name").lower()== country_name.lower()]

# print(native_name("india"))

#display the callingcode of all asian countries************************************


def asian_calling_code():
    
   return [(c.get("name"),c.get("callingCodes")) for c in countries if c.get("region").lower()=="asia".lower()]

# print(asian_calling_code())

#display the timezone of India***********************************


def time_zone(country_name):
    
    return [(c.get("name"),c.get("timezones")) for c in countries if c.get("name").lower()==country_name.lower()]

# print(time_zone("india"))


#display subregion of "region": "Africa" countries*******************************

def sub_region():
    
    return [(c.get("name"),c.get("region"),c.get("subregion")) for c in countries if c.get("region").lower()== "africa".lower()]
  
# print(sub_region())

 #display alpha2 and alpha3 code of india*****************************************
    

def alpha_code(country_name):

    return [(c.get("name"),c.get("alpha2Code"),c.get("alpha3Code")) for c in countries if c.get("name").lower()==country_name.lower()] 

# print(alpha_code("INDIA"))  


#display alternate spelling of least populated country*****************************

def least_population():
    
    population_count = [c.get("population") for c in countries]

    # print(population_count)

    least_pop = min(population_count)

    # least_pop_country_name = [c.get("name") for c in countries if c.get("population")==least_pop]

    # print(least_pop_country_name)

    return [(c.get("name"),c.get("altSpellings") )for c in countries if c.get("population")==least_pop]

# print(least_population())

#display the regional block of china***********************

def regional_block(country_name):
